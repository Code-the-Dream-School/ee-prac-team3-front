...
export default function Header({profileSettings, userData, auth}) {
    ...
    const handleOpenUserMenu = (e) => {
        setHeaderState((prevState) => ({...prevState, anchorElUser: e.currentTarget}));
    };
    ...
    const isLogoOnRight = [LOGIN, SIGNUP, RESET_PASSWORD].includes(location.pathname);
            ...
            <Container sx={{maxWidth: '1200px'}}>
                <Toolbar disableGutters sx={{justifyContent: 'space-between'}}>
                    {isLogoOnRight && (
                        <Box sx={{flexGrow: 1}}/>)}
                    <Link to={HOME}>
                        <Avatar src={jsQuizLogo} variant='square' sx={{
                            width: '100px',
                            height: '100%',
                            flexGrow: 0,
                            ...
                            marginLeft: 'auto',
                            [defaultTheme.breakpoints.up('md')]: isLogoOnRight && {display: 'none'},
                    ...
                    <Box sx={{
                        display: 'flex', alignItems: 'center', marginLeft: '350px',
                    ...
                    <Box sx={{display: 'flex', alignItems: 'center'}}>
                        <AboutElement/>
                        <Box sx={{flexGrow: 0, display: isUserMenuVisible ? 'flex' : 'none'}}>
