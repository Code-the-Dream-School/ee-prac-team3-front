                    ...
                    <CardContent sx={{
                        ...
                        <Box sx={{display: "flex", flexDirection: "column", justifyContent: "space-between"}}>
                            <Box sx={{
                                ...
                                <Labels labels={quiz.labels} isFilterActive={isFilterActive}></Labels>
                                <Chip
                                    sx={{
                                        borderRadius: '4px',
                                        fontWeight: 'bold',
                                        backgroundColor: isFilterActive('levels', quiz.level) ?
                                            customColors.blueMedium : customColors.grey,
                                        color: isFilterActive('levels', quiz.level) ?
                                            customColors.grey : customColors.blueMedium,
                                    }}

                                    size={isSmallScreen ? "medium" : "small"} label={quiz.level}/>
                                <Chip
                                    sx={{
                                        borderRadius: '4px',
                                        fontWeight: 'bold',
                                    ...
                                    size={isSmallScreen ? "medium" : "small"} label={quiz.category}/>
                            </Box>
                            <Box>
                                <Typography sx={{marginTop: '10px', color: customColors.greyMedium}}>
                                    {progress.attemptsCount ? `Attempts: ${progress.attemptsCount}` : 'Not Passed'}
                                </Typography>
                            </Box>
                        </Box>
