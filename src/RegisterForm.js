...
import {Box, Link, Button, Grid, Container, IconButton, Input, InputLabel, InputAdornment, FormControl, TextField, Typography} from '@mui/material';
    ...
    return (
        <Container maxWidth = "md" style={{minWidth: "500px"}}>
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={12}>
                        <FormControl sx={{ m: 1, width: '100%', boxSizing:'border-box'}} variant="standard">
                ...
                <div style={{paddingTop:'20px', paddingLeft:'5px'}}>
                    <Button variant = "contained" color="info" onClick={() => onSubmitData(userData)} fullWidth>Register</Button>
                </div>

                <div style={{display:"flex", flexDirection:"row", justifyContent:"flex-end", paddingTop:'10px', paddingInline:'15px'}}>
                    <Link href="#" onClick={() => onLoginRedirect()}>Login Instead</Link>
                </div>
        </Container>
    );
}